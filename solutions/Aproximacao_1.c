...
/*****************************************************************************/
/* Arquivo: Aproximacao_1.c | Versão 1.0 | Ano: 2014                         */
/*---------------------------------------------------------------------------*/
...
{
    int i;
    double soma1 = 0.0, soma2 = 0.0, soma3 = 0.0, soma4 = 0.0, soma5 = 0.0;
    ...
    return ((soma1 * soma2 - soma3 * soma4) / (((double)m * soma1) - (soma4 * soma4)));
}
...
double get_a1(int m)
{
    ...
    return (((double)m * soma1 - soma2 * soma3) / ((double)m * soma4 - (soma2 * soma2)));
}
